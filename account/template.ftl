    ...
    <div class="container">
      <nav class="navbar navbar-expand-xl p-0">
        <div class="navbar-brand">
          <a href="${(referrer.url)!"https://www.hyvio.fi"}">
        ...
        <div class="justify-content-end">
          <ul id="menu-paavalikko" class="navbar-nav">
            <li id="menu-item-59" class="nav-item menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-18 current_page_item menu-item-59 active">
              <a href="${(referrer.url)!"https://www.hyvio.fi"}" id="referrer">${msg("backToApplication")}</a>
            </li>
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu">
                <li class="dropdown-menu-item"><a href="${(referrer.url)!"https://www.hyvio.fi"}" id="referrer">${msg("backToApplication")}</a></li>
